...
export default function TermsConditions() {
  return (
    <div className="terms-container">
      ...
      <p>
        Revisions are contingent on the package selected. Clients can approach us for unlimited free
        amendments and we will revise their design with no extra charges, given that the design and
        concept remain intact. Revision turnaround time will be 48 hours.
      </p>
      ...
      <ul>
        <li>You make a solicitation when the underlying ideas for a logo are provided. Once you approve or ask for changes in the initial designs, the refund offer will be void.</li>
        <li>Once the project has been entered in revision phase, the refund offer will be void.</li>
        <li>If the refund request is made before the delivery of initial design concepts, you qualify for a full refund (less 10% service & processing fee).</li>
        <li>If the refund request is made within 48 hours, you are eligible for 66% refund (less 10% fee).</li>
        <li>If made within 48-96 hours after delivery, eligible for 33% refund (less 10% fee).</li>
        <li>No refund after 96 hours of initial design delivery.</li>
        <li>Other conditions apply as per active client communication and contract terms.</li>
      </ul>

      <h3>How To Claim Your Refund</h3>
      <p>
        To ensure that your refund request is processed effectively, specify your concern via one
        of these:
      </p>
      <ul>
      ...
      <h3>2.2 Your Obligations and Conduct</h3>
      <ul>
        <li>Provide accurate, current, and complete information prompted by registration forms.</li>
      ...
      <h3>2.3 Your Responsibilities</h3>
      <ul>
      ...
      <p>
        Customer shall own all right, title and interest in the Deliverables after full payment.
        Consultant pre-existing IP remains licensed to the customer only along with the Deliverables.
      </p>

      <h3>2.7 Warranties</h3>
      <p>
        Except as expressly stated, all warranties are disclaimed including implied warranties of
